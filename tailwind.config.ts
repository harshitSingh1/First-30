  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "pulse-glow": {
          "0%, 100%": { 
            boxShadow: "0 0 20px hsl(187 85% 43% / 0.4), 0 0 40px hsl(187 85% 43% / 0.2)" 
          },
          "50%": { 
            boxShadow: "0 0 30px hsl(187 85% 43% / 0.6), 0 0 60px hsl(187 85% 43% / 0.3)" 
          },
        },
        "pulse-emergency": {
          "0%, 100%": { 
          ...
          "50%": { 
            boxShadow: "0 0 40px hsl(0 84% 60% / 0.6), 0 0 60px hsl(0 84% 60% / 0.3)" 
          },
        },
        "heartbeat": {
